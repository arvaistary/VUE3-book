...
- This workflow owns `spec.md`.
- Treat unresolved template markers as blocking. Replace shipped placeholder headings, instructional comments, bracketed examples, and sample bullets with concrete specification content.
...
- If essential information is missing, use explicit, fact-specific `NEEDS CLARIFICATION` markers instead of leaving generic template text in place.
