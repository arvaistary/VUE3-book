...
части 1 добавляется синтетический разбор перехода к структуре Nuxt 4; он
проверяется по официальной документации и не описывает закрытый репозиторий.
...
6. Для framework-зависимых утверждений сверить версии и пример миграции с
   официальной документацией Nuxt непосредственно перед финализацией.
